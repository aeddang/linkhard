...
import kotlinx.android.synthetic.main.popup_progress.*
import kotlinx.android.synthetic.main.popup_progress.recyclerView
...
class PopupDownLoad : RxPageFragment() {
    ...
    override fun getLayoutResId() = R.layout.popup_progress
        ...
        override fun onCreatedView() {
            currentData?.let {data->
                ...
                btnOpen.clicks().subscribe {
                    if(data.fileStatus != FileStatus.Completed) return@subscribe
